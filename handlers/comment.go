...
// 		comments[i].Children = handler.fillChildren(comments[i].Children)
// 	}
...
// func (handler CommentHandler) fillChildren(children []models.Comment) []models.Comment {
// 	var result []models.Comment
// 	for _, child := range children {
// 		child.Children = handler.fillChildren(child.Children)
...
// 	// 	database.DB.Where("id = ?", comment.ParentCommentID).First(&parentComment)
// 	// 	utils.SendEmail(
// 	// 		parentComment.Email,
// 	// 		comment.Content,
// 	// 	)
